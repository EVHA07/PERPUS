                ...
                <div class="card-body">
                    <form method="post" action="{{ route('user.update', $user->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="userid" type="text" value="{{ $user->id }}" class="form-control" name="userid" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" value="{{ $user->username }}" class="form-control @error('username') is-invalid @enderror" name="username" required autocomplete="username">
                                @error('username')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nama_lengkap" type="text" value="{{ $user->nama_lengkap }}" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" required autocomplete="nama_lengkap" autofocus>
                                @error('nama_lengkap')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="text" value="{{ $user->alamat }}" class="form-control @error('alamat') is-invalid @enderror" name="alamat" required autocomplete="alamat">
                                @error('alamat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
